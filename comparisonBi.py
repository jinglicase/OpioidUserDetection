...
def iterExperiment(X, Y):
    ...
    for i in range(0,numIters):
        for train, test in kfold.split(X, Y):
            ...
            f1LR_separate_res.append(f1LR)
            f1NB_separate_res.append(f1NB)
            f1RT_separate_res.append(f1Tree)
            f1RF_separate_res.append(f1RF)
            f1SVM_separate_res.append(f1SVM)
    ...
    print(f1LR_separate_res)
    print(f1NB_separate_res)
    # print(sum(f1NB_separate_res)/15)
    print(f1RT_separate_res)
    print(f1RF_separate_res)
    print(f1SVM_separate_res)
